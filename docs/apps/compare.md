---
title: Compare h3p apps
description: Compare h3p apps by purpose, platform, release status, access path, and privacy model.
---

# Compare h3p apps

Use this view when you know the job you want to do but not which app is the best fit. Every row links to the app’s overview, installation guide, release notes, and privacy information.

<div class="compare-actions"><a class="compare-primary" href="/apps/index">Browse and filter all apps</a><a href="/support/docs-assistant">Open the docs assistant</a></div>
...
| [Vistral](/apps/vistral/overview) | Local-first dashboards and insights | macOS · iPadOS · iOS · tvOS · watchOS · visionOS | Private beta · 0.1.6 (2026-05-09) | [Request access](/support/support-and-feedback) | [Website policy](/policies/privacy-policy) |
...
| [Lingua Latina](/apps/lingua-latina/overview) | Latin dictionary, grammar, and study | macOS · iPadOS · iOS | Private beta · 1.0.0 (2026-05-14) | [Request access](/support/support-and-feedback) | [App policy](/apps/lingua-latina/privacy-policy) |
...
- **Language study:** [Lingua Latina](/apps/lingua-latina/overview)

<style>
.compare-actions { display: flex; flex-wrap: wrap; gap: 10px; margin: 18px 0 24px; }
.compare-actions a { border: 1px solid var(--vp-c-divider); border-radius: 999px; padding: 9px 13px; text-decoration: none; }
.compare-actions .compare-primary { border-color: var(--vp-c-brand-1); background: var(--vp-c-brand-1); color: #fff; }
.vp-doc table { display: table; width: 100%; }
</style>
