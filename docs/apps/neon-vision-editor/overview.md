...
<div class="overview-mini-stats overview-reveal" aria-label="app stats">
  <div><span>latest version</span><strong>v1.7.6</strong></div>
...
- [Latest GitHub Release (v1.7.6)](https://github.com/h3pdesign/Neon-Vision-Editor/releases/tag/v1.7.6)
...
Direct GitHub releases currently track v1.7.6. App Store and TestFlight availability can vary by platform and review state.
