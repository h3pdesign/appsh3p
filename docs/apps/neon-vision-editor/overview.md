...
<p class="overview-last-updated">Last updated: <span data-date="2026-09-05">September 5, 2026</span></p>
...
<div class="overview-mini-stats overview-reveal" aria-label="app stats">
  <div><span>latest version</span><strong>v1.6.2</strong></div>
...
<div class="overview-hero overview-app-neon overview-reveal">
  ...
  <div class="overview-hero-media">
    ...
    <div class="overview-download-badges overview-download-badges-hero" aria-label="Download Neon Vision Editor">
      ...
      <a class="overview-download-badge overview-download-github" href="https://github.com/h3pdesign/Neon-Vision-Editor/releases/tag/v1.6.2" target="_blank" rel="noreferrer noopener">
        <span>Download: </span>
        <strong>GitHub v1.6.2</strong>
      </a>
    </div>
  </div>
</div>
...
- [Latest GitHub Release (v1.6.2)](https://github.com/h3pdesign/Neon-Vision-Editor/releases/tag/v1.6.2)
...
Direct GitHub releases currently track v1.6.2. App Store and TestFlight availability can vary by platform and review state.
