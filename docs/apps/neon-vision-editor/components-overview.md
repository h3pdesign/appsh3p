...
_Source basis: GitHub repository structure and architecture notes for [`h3pdesign/Neon-Vision-Editor`](https://github.com/h3pdesign/Neon-Vision-Editor), main branch (README and architecture docs last updated July 22, 2026 for v0.9.4)._
...
| Core Services | Syntax, language detection, document diffing, project indexing, release policy, remote sessions | [`Core/`](https://github.com/h3pdesign/Neon-Vision-Editor/tree/main/Neon%20Vision%20Editor/Core) |
| Data + State | Editor state, Git state, secure token persistence, support flow state | [`Data/`](https://github.com/h3pdesign/Neon-Vision-Editor/tree/main/Neon%20Vision%20Editor/Data) |
...
- [`ProjectFileIndex.swift`](https://github.com/h3pdesign/Neon-Vision-Editor/blob/main/Neon%20Vision%20Editor/Core/ProjectFileIndex.swift): incremental file indexing for Quick Open and Find in Files.
- [`DocumentDiff.swift`](https://github.com/h3pdesign/Neon-Vision-Editor/blob/main/Neon%20Vision%20Editor/Core/DocumentDiff.swift): line-oriented document diffing for compare workflows.
- [`RemoteSessionStore.swift`](https://github.com/h3pdesign/Neon-Vision-Editor/blob/main/Neon%20Vision%20Editor/Core/RemoteSessionStore.swift): opt-in remote browsing, open/save, and revision-conflict state.
...
- [`GitViewModel.swift`](https://github.com/h3pdesign/Neon-Vision-Editor/blob/main/Neon%20Vision%20Editor/Data/GitViewModel.swift): Git sidebar state that delegates repository work to the macOS Git service.
...
- [`ContentView+MarkdownFormatting.swift`](https://github.com/h3pdesign/Neon-Vision-Editor/blob/main/Neon%20Vision%20Editor/UI/ContentView%2BMarkdownFormatting.swift): contextual Markdown formatting controls.
- [`ContentView+PreviewSplit.swift`](https://github.com/h3pdesign/Neon-Vision-Editor/blob/main/Neon%20Vision%20Editor/UI/ContentView%2BPreviewSplit.swift): editor/preview allocation and compact presentation choices.
- [`ContentView+TabChromeStatus.swift`](https://github.com/h3pdesign/Neon-Vision-Editor/blob/main/Neon%20Vision%20Editor/UI/ContentView%2BTabChromeStatus.swift): tab chrome, external-refresh status, and status-bar presentation.
...
flowchart LR
  ...
  D --> I["Document Observation + Diff"]
  D --> J["Project Index + Remote Sessions"]
...
3. Core services run detection, highlighting, document observation, diffing, project indexing, and update checks as needed.
...
- External file refresh and dirty-buffer conflict handling.
- Minimap viewport publication during scrolling and tab changes.
...
- New remote or Git behavior: keep process execution on macOS-owned services and route mobile/spatial surfaces through explicit client flows.
