...
const appUpdatedBySlug: Record<string, string> = {
  'neon-vision-editor': 'April 24, 2026',
  ...
  if (!container.querySelector('.home-hero-widgets')) {
    ...
    widget.innerHTML = `
      <section class="home-hero-widget-card">
        ...
        <div class="home-deploy-badge"><a href="https://github.com/h3pdesign/appsh3p/commit/ae3e8f2" target="_blank" rel="noreferrer noopener">Last deployment: <span data-date="2026-04-24">April 24, 2026</span></a></div>
      ...
      <section class="home-hero-widget-card home-hero-ticker">
        ...
        <p><strong>Neon Vision Editor v0.6.2</strong> published on April 24, 2026.</p>
        <a href="https://github.com/h3pdesign/Neon-Vision-Editor/releases/tag/v0.6.2" target="_blank" rel="noreferrer noopener">View GitHub release</a>
      </section>
    `
