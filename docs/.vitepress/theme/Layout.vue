...
const appUpdatedBySlug: Record<string, string> = {
  'neon-vision-editor': 'August 22, 2026',
  ...
  if (!container.querySelector('.home-hero-widgets')) {
    ...
    widget.innerHTML = `
      <section class="home-hero-widget-card">
        ...
        <div class="home-deploy-badge"><a href="https://github.com/h3pdesign/appsh3p/commits/main" target="_blank" rel="noreferrer noopener">Last docs sync: <span data-date="2026-08-22">August 22, 2026</span></a></div>
      ...
      <section class="home-hero-widget-card home-hero-ticker">
        ...
        <p><strong>Neon Vision Editor v1.5.2</strong> published on August 22, 2026.</p>
        <a href="https://github.com/h3pdesign/Neon-Vision-Editor/releases/tag/v1.5.2" target="_blank" rel="noreferrer noopener">View GitHub release</a>
      </section>
    `
