...
const appUpdatedBySlug: Record<string, string> = {
  'neon-vision-editor': 'July 21, 2026',
  ...
  if (!container.querySelector('.home-hero-widgets')) {
    ...
    widget.innerHTML = `
      <section class="home-hero-widget-card">
        ...
        <div class="home-deploy-badge"><a href="https://github.com/h3pdesign/appsh3p/commit/ae3e8f2" target="_blank" rel="noreferrer noopener">Last deployment: <span data-date="2026-07-21">July 21, 2026</span></a></div>
      ...
      <section class="home-hero-widget-card home-hero-ticker">
        ...
        <p><strong>Neon Vision Editor v0.9.3</strong> published on July 21, 2026.</p>
        <a href="https://github.com/h3pdesign/Neon-Vision-Editor/releases/tag/v0.9.3" target="_blank" rel="noreferrer noopener">View GitHub release</a>
      </section>
    `
