...
const appUpdatedBySlug: Record<string, string> = {
  'neon-vision-editor': 'February 19, 2026',
  ...
  if (!container.querySelector('.home-hero-widgets')) {
    ...
    widget.innerHTML = `
      ...
      <section class="home-hero-widget-card home-hero-ticker">
        ...
        <p><strong>Neon Vision Editor v0.4.27</strong> published on February 19, 2026.</p>
        <a href="https://github.com/h3pdesign/Neon-Vision-Editor/releases/tag/v0.4.27" target="_blank" rel="noreferrer noopener">View GitHub release</a>
      </section>
    `
