...
const appUpdatedBySlug: Record<string, string> = {
  'neon-vision-editor': 'September 12, 2026',
  ...
  if (!container.querySelector('.home-hero-widgets')) {
    ...
    widget.innerHTML = `
      <section class="home-hero-widget-card">
        ...
        <div class="home-deploy-badge"><a href="https://github.com/h3pdesign/appsh3p/commits/main" target="_blank" rel="noreferrer noopener">Last docs sync: <span data-date="2026-09-12">September 12, 2026</span></a></div>
        <div class="home-hero-mini-apps" aria-label="App icons">
          ...
          <a href="/apps/history-vision/overview"><img src="/icons/history-vision.png?v=20260914-2" alt="History Vision" width="22" height="22" loading="lazy" decoding="async" /></a>
        </div>
      </section>
      ...
      <section class="home-hero-widget-card home-hero-ticker">
        ...
        <p><strong>Neon Vision Editor v1.7.6</strong> published on September 12, 2026.</p>
        <a href="https://github.com/h3pdesign/Neon-Vision-Editor/releases/tag/v1.7.6" target="_blank" rel="noreferrer noopener">View GitHub release</a>
      </section>
    `
