...
const appUpdatedBySlug: Record<string, string> = {
  'neon-vision-editor': 'August 16, 2026',
  ...
  if (!container.querySelector('.home-hero-widgets')) {
    ...
    widget.innerHTML = `
      <section class="home-hero-widget-card">
        ...
        <div class="home-deploy-badge"><a href="https://github.com/h3pdesign/appsh3p/commits/main" target="_blank" rel="noreferrer noopener">Last docs sync: <span data-date="2026-08-16">August 16, 2026</span></a></div>
      ...
      <section class="home-hero-widget-card home-hero-ticker">
        ...
        <p><strong>Neon Vision Editor v1.4.6</strong> published on August 16, 2026.</p>
        <a href="https://github.com/h3pdesign/Neon-Vision-Editor/releases/tag/v1.4.6" target="_blank" rel="noreferrer noopener">View GitHub release</a>
      </section>
    `
